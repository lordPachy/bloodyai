...
def inference_with_ResNet18(model, labels, img):
    ...
    x = torchvision.io.read_image(path = img)
    c, h, w = x.shape
...
model = prepare_ResNet18('/home/pachy/Desktop/ACSAI/bloodyai/classification/parameters/state_dict_model.pt')
# ...AND THE TEST IMAGE
print(inference_with_ResNet18(model, labels, '/home/pachy/Desktop/ACSAI/bloodyai/classification/test.jpg'))
